...
import com.example.shopgrocery.Adapters.AdapterOrderedItem;
import com.example.shopgrocery.models.ModelOrderedItems;
...
//                        orderCost = orderCost.replaceAll("\\(.*[\\)]", "").replaceAll(" \\(", "").replaceAll("\\)", "").replaceAll("$","");
