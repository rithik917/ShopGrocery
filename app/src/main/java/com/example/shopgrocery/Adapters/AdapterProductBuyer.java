package com.example.shopgrocery.Adapters;
...
import com.example.shopgrocery.FilterProductBuyer;
import com.example.shopgrocery.R;
import com.example.shopgrocery.models.ModelProduct;
...
public class AdapterProductBuyer extends RecyclerView.Adapter<AdapterProductBuyer.HolderAdapterBuyer> implements Filterable{
    ...
    public void onBindViewHolder(@NonNull HolderAdapterBuyer holder, int position) {
        ...
        holder.orignalPriceTv.setText("Rs"+orignalPrice);
    ...
    private void showQuantityDialog(ModelProduct modelProduct) {
        ...
        actualFinalCost = Double.parseDouble(orgnalPrice.replaceAll("Rs", ""));
        quantity = 1;
        ...
        orignalPriceTV.setText("Rs"+modelProduct.getOrignalPrice());
        discountPriceTV.setText("Rs"+modelProduct.getDiscountPrice());
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String actualPrice = "Rs" + actualFinalCost;
