...
import com.example.shopgrocery.Adapters.AdapterOrderUser;
import com.example.shopgrocery.Adapters.AdapterShop;
import com.example.shopgrocery.models.ModelOrderUser;
import com.example.shopgrocery.models.ModelShop;
...
public class MainBuyerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainBuyerActivity.this,Setting.class));
            }
        });
