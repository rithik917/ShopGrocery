...
import com.example.shopgrocery.Adapters.AdapterOrderShop;
import com.example.shopgrocery.Adapters.AdapterProductSeller;
import com.example.shopgrocery.models.ModelOrderShop;
...
public class MainSellerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainSellerActivity.this,Setting.class));
            }
        });
    }
